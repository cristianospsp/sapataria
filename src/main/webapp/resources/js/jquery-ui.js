...
$.extend(Datepicker.prototype, {
	...
	_attachments: function(input, inst) {
		...
		if(showOn === "bootstrap"){
		        var icone = $('<i>').addClass('glyphicon glyphicon-calendar');
			var btn = $("<button type='button'></button>").addClass(this._triggerClass);
		        /*btn.addClass("btn btn-default").html(icone);*/
            btn.html(icone);
			/*var spanBtn = $('<span>').addClass('input-group-btn').html(btn);*/
			/*inst.trigger = spanBtn;*/
			inst.trigger = btn;
